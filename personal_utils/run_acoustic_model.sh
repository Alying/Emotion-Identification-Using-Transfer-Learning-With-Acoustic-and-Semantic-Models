...
nnet3-copy --nnet-config=$nnet_dir/configs/extract.config local/data/kaldi-trunk/egs/tedlium/s5_r3/$model_dir/final.mdl local/data/kaldi-trunk/egs/tedlium/s5_r3/$model_dir/final.raw

cp $model_dir/final.raw ../../../../../../local/data/
cd ../../../../../../
echo "$PWD"
nnet3-xvector-compute --min-chunk-size=25 local/data/final.raw scp:local/data/${dset}_hires/feats.scp ark,scp:local/data/${dset}_hires/nnet_prediction.ark,local/data/${dset}_hires/nnet_prediction.scp
