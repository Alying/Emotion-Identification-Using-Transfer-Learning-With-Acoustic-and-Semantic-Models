...
#
phones <- read.table("exp/tri3_cleaned_ali_train_cleaned_sp/phones.txt", quote="\"")
segments <- read.table("exp/tri3_cleaned_ali_train_cleaned_sp/segments.txt", quote="\"")
ctm <- read.table("exp/tri3_cleaned_ali_train_cleaned_sp/merged_alignment.txt", quote="\"")
